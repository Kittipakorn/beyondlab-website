    ...
    <section className="mx-auto grid min-h-[70dvh] max-w-7xl place-items-center px-5 py-16 sm:px-8">
      ...
      >
        ...
        <div className="mt-6 flex flex-col justify-center gap-3 sm:flex-row">
          ...
          <Link href={retryHref} className="inline-flex min-h-11 items-center justify-center rounded-xl bg-[#ea721f] px-5 text-sm font-bold text-white transition hover:bg-[#cf5d12] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#ea721f] focus-visible:ring-offset-2">
            ลองใหม่
          </Link>
        </div>
      </div>
