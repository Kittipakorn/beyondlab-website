...
export function FloatingContact() {
  ...
  return (
    <a
      ...
      className="group fixed bottom-6 right-5 z-40 flex h-14 items-center gap-2 rounded-full bg-[#111111] pl-4 pr-4 text-white shadow-[0_20px_50px_rgba(17,17,17,0.35)] transition hover:-translate-y-0.5 hover:pr-5 sm:right-8"
    >
      <InstagramIcon />
